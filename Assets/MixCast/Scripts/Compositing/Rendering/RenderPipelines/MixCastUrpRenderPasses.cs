    ...
    public static class MixCastUrpRenderPasses
    {
        public class AfterOpaquePass : ScriptableRenderPass
        {
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                Blit(cmd, colorTarget, cam.OpaqueLayerTex, cam.TransferOpaqueMat);
                Blit(cmd, Texture2D.blackTexture, colorTarget, cam.ResetForTransparentMat);
        ...
        public class SaveAlphaPass : ScriptableRenderPass
        {
            ...
            {
                var cmd = CommandBufferPool.Get();
                Blit(cmd, colorTarget, cam.CleanColorTarget, cam.TransferAlphaMat);
                context.ExecuteCommandBuffer(cmd);
                CommandBufferPool.Release(cmd);
            }
        }
